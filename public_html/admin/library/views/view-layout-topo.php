...
<head>
	...
	<link rel="shortcut icon" href="/admin/favicon.ico" type="image/vnd.microsoft.icon"><!--The 2010 padrão IANA mas não suportado no IE-->
...
<ul id="todo">
	<li style="" class="topo-list">
		...
		<div id="info-topo" class="wrap">
			<div id="marca-cliente">
				<?php
					if(Sis::config("CLI_LOGO")){
						echo '<img src="/admin/public/images/' . Sis::config("CLI_LOGO") . '">';
					}else{
						if(!Sis::config("CLI_NOME") === FALSE){
							echo "<h1>".Sis::config("CLI_NOME")."</h1>";
						}
					}
				?>
			</div>
			<div id="info-usuario-topo">
				<div class="saudacao-and-topo">
					...
					<a class="logo-sistema" href="">
						<img src="/admin/public/images/logo-directin.jpg" height="33">
					</a>
