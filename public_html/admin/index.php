				...
				<div id="content-real">
					...
					<?php
						...
						?>
							...
							<script type="text/javascript">setTimeout(function(){ $('#alert-bts').slideUp('slow'); },20000);</script>
							...
							if(file_exists('modulos/'.$mod.'/'.$pag.'-control.php')){
								...
								*/
								if(file_exists('modulos/'.$mod.'/'.$mod.'-style.css')){
									echo '<link rel="stylesheet" href="/admin/modulos/'.$mod.'/'.$mod.'-style.css">';
								}
								if(file_exists('modulos/'.$mod.'/'.$mod.'-scripts.js')){
									echo '<script type="text/javascript" src="/admin/modulos/'.$mod.'/'.$mod.'-scripts.js"></script>';
								}
							}else{
								/**
