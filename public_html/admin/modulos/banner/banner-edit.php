...
<form action="<?php echo Sis::currPageUrl(); ?>" method="post" class="form_dados" name="form_dados" enctype="multipart/form-data" >
 ...
 <table class="table table_form">
		<tr>
			...
			<td width="25%" >
				<label class="radio-inline" ><input type="radio" name="formato" value="1" id="formato-1" <?php if ($lista_arr['formato'] == 1) { echo 'checked'; } ?> >Imagem</label>
				<label class="radio-inline" ><input type="radio" name="formato" value="2" id="formato-2" <?php if ($lista_arr['formato'] == 2) { echo 'checked'; } ?> >Adobe Flash</label>
			</td>
		</tr>
		<tr>
			<th class="top bg">Alinhamento</th>
			<td>
				<div class="radio"><label><input type="radio" name="alinhamento" value="0" id="alinhamento" <?php if ($lista_arr['alinhamento'] == 0) { echo 'checked'; } ?> > Esquerda</label></div>
				<div class="radio"><label><input type="radio" name="alinhamento" value="1" id="alinhamento" <?php if ($lista_arr['alinhamento'] == 1) { echo 'checked'; } ?> > Centralizado</label></div>
            <div class="radio"><label><input type="radio" name="alinhamento" value="2" id="alinhamento" <?php if ($lista_arr['alinhamento'] == 2) { echo 'checked'; } ?> > Direita</label></div>
			</td>
			...
			<td width="25%" class="top">
				<div class="checkbox"><label><input type="checkbox" name="monitor_impressao" value="1" id="monitor_impressao" <?php if ($lista_arr['monitor_impressao'] == 1) { echo 'checked'; } ?> > Impresão</label></div>
				<div class="checkbox"><label><input type="checkbox" name="monitor_clique" value="1" id="monitor_clique" <?php if ($lista_arr['monitor_clique'] == 1) { echo 'checked'; } ?> > Clique</label></div>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan="3"><textarea name="descricao" id="descricao" class="ckeditor" ><?php echo $lista_arr['descricao']; ?></textarea></td>
		</tr>
		<tr>
			<th class="top bg">
				Arquivo<br>
			...
			<td colspan="3">
				<div class="fl_left">
					...
					largura: <b><?=$listaTipo[0]['largura']?>px</b>  &nbsp;x&nbsp;
					altura: <b><?=$listaTipo[0]['altura']?>px</b> <br>
					<br />
