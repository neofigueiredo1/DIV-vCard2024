...
class banner_tipo extends banner_tipo_model{
	...
	public function inserir() {
		...
		$dados = parent::inserir_m($status, $formato, $alinhamento, $tipo, $pagina_opcoes, $nome, $descricao, $url, $alvo, $arquivo, $horario,$horario_ini,$horario_fim, $indica_data, $data_publicacao, $data_expiracao);
		ob_end_clean();
