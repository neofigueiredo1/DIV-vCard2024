...
class banner_model extends HandleSql {
	...
	public function inserir_m($status, $formato, $alinhamento, $tipo, $pagina, $nome, $descricao, $url, $alvo, $arquivo, $horario, $horario_ini,$horario_fim, $indica_data, $data_publicacao, $data_expiracao){
	...
	public function atualizar_m($b_id, $status, $formato, $tipo, $alinhamento, $pagina, $nome, $descricao, $url, $alvo, $arquivo, $horario, $horario_ini, $horario_fim, $indica_data, $data_publicacao, $data_expiracao){
