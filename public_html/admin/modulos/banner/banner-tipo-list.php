				...
				<table class="table table-hover table-striped table_list">
					<thead>
						<tr>
							<th width="0%">&nbsp;&nbsp;#&nbsp;</th>
							<th width="40%">Nome</th>
							<th width="10%" >Efeitos</th>
							<th width="18%">Tempo de intervalo</th>
							<th width="18%">Tempo de execução</th>
							<th width="7%">Largura</th>
	            ...
	            foreach (Sis::jqueryEfx() as $key => $value) {
					...
					echo '
						...
						<tr>
							...
							<td>
								<div style="width:120px; float:left;" title="'.$efx.'" >'.$efx.'</div>
							</td>
							<td>' . $arrayList['animacao_tempo'] . 's</td>
							<td>' . $arrayList['animacao_velocidade'] . 's</td>
							<td>' . $arrayList['largura'] . 'px</td>
							<td>' . $arrayList['altura'] . 'px</td>
							<td nowrap>
		               ';
		               echo   '<a class="a_tooltip" data-placement="top" title="Lista de banners" href="?mod=' . $mod . '&pag=' . $pag . '&act=list&tid=' . $arrayList['tipo_idx'] . '" > <i class="fa fa-list-ul"></i></a>&nbsp;';
