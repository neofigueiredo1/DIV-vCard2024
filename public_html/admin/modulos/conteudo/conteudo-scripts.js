...
jQuery(document).ready(function($) {
	...
	$('#paginas-out, #paginas-in').sortable({
		connectWith: "ul",
	...
	if ($('ol.sortable').length>0)
	{
		$('ol.sortable').nestedSortable({
			...
			maxLevels: 2,
			stop: function(){ _timeout = setTimeout(function(){  atualizaLista($('ol.sortable').nestedSortable('serialize')); },1000); },
