...
CREATE TABLE `divvcard_cadastro` (
  ...
  `theme_color_a` varchar(45) DEFAULT NULL,
  `theme_color_b` varchar(145) DEFAULT NULL,
  `theme_color_c` varchar(45) DEFAULT NULL,
  ...
  `data_cadastro` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `vcard` varchar(145) DEFAULT NULL,
...
INSERT INTO `divvcard_cadastro` VALUES (2,1,'Neo Figueiredo','Neo Figueiredo',1,'','neo@div.tec.br','930e3c83d838d1361f7d7a3610f8f1fc','','','(85) 98851-0555','','','','','','','','','profile-neofigueiredo.png','','neofigueiredo','DIV Soluções em Tecnologia','Chief Technology Officer','https://div.tec.br',NULL,NULL,NULL,NULL,NULL,'Sou sócio diretor na DIV Soluções em Tecnologia, empresa focada no desenvolvimento de aplicações  web e mobile, que também atua na análise de novos produtos e Big Data para diversas empresas do mercado.',0,'2024-10-03 19:13:09',NULL);
/*!40000 ALTER TABLE `divvcard_cadastro` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `divvcard_cadastro_links`
--

DROP TABLE IF EXISTS `divvcard_cadastro_links`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `divvcard_cadastro_links` (
  `link_idx` int NOT NULL AUTO_INCREMENT,
  `cadastro_idx` int DEFAULT NULL,
  `status` int DEFAULT NULL,
  `icone` varchar(145) DEFAULT NULL,
  `titulo` varchar(245) DEFAULT NULL,
  `valor` varchar(245) DEFAULT NULL,
  `ranking` int DEFAULT NULL,
  PRIMARY KEY (`link_idx`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `divvcard_cadastro_links`
--

LOCK TABLES `divvcard_cadastro_links` WRITE;
/*!40000 ALTER TABLE `divvcard_cadastro_links` DISABLE KEYS */;
INSERT INTO `divvcard_cadastro_links` VALUES (1,2,1,'fas fa-external-link-alt','div.tec.br','https://div.tec.br',3),(2,2,1,'fab fa-whatsapp','+55 85 988510555','phone:+5585988510555',1),(3,2,1,'fab fa-instagram','@divtecbr','https://www.instagram.com/divtecbr/',4),(4,2,1,'fab fa-linkedin','@neo-figueiredo','https://www.linkedin.com/in/neo-figueiredo/',2);
/*!40000 ALTER TABLE `divvcard_cadastro_links` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-10-03 19:40:01
